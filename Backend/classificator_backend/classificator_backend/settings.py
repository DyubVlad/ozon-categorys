"""
Django settings for classificator_backend project.
...
ROOT_URLCONF = 'classificator_backend.urls'
...
WSGI_APPLICATION = 'classificator_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'textsFromOzon.db',
    }
}
